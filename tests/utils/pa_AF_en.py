...
def test_pa_AF_en_automotive():
    assert fake.license_plate()

def test_pa_AF_en_bank():
    assert fake.bank()
...
def test_pa_AF_en_codes():
    assert fake.ean13()
    assert fake.upc_a()

def test_pa_AF_en_colors_company():
    assert fake.color()
    assert fake.color_name()
    assert fake.company()
    assert fake.pricetag()

def test_pa_AF_en_datetime():
...
def test_pa_AF_en_internet_books():
    assert fake.domain_name()
    assert fake.isbn13()
    assert fake.isbn10(separator="/")

def test_pa_AF_en_jobs_text():
    assert fake.job()
