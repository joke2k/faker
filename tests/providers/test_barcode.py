...
class TestEnUS:
    ...
    def test_localized_ean(self, faker, num_samples):
        from faker.providers.barcode.en_US import Provider
        for _ in range(num_samples):
            ...
            assert any(
                ...
                for prefix in Provider.local_prefixes
            )
            assert any(
    ...
    def test_localized_ean8(self, faker, num_samples):
        from faker.providers.barcode.en_US import Provider
        for _ in range(num_samples):
    ...
    def test_localized_ean13(self, faker, num_samples):
        from faker.providers.barcode.en_US import Provider
        for _ in range(num_samples):
