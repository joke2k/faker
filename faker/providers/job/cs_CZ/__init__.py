...
class Provider(JobProvider):
    ...
    jobs = (
        ...
        "Autorizovaný účetní",
        "Autorizovaný účetní v oblasti veřejných financií",
        "Bankéř",
        "Baňský inženýr",
        "Barista",
        "Biochemik, klinický",
        ...
        "Inspektor / hodnotitel reklamaci",
        ...
        "Inženýr zemědělství",
        "Inženýr pre automobilový průmysl",
        ...
        "Kariérní poradce",
        "Kariérní poradce pre vysokoškolské vzdělání",
        "Kartograf",
        "Klinický biochemik",
        ...
        "Pojišťovák",
        "Police officer",
        "Poradca pro zdraví a bezpečnosť",
        "Poradca pre životní prostředí",
        ...
        "Referent pre nouzové plánování / řízení",
        "Referent pre výstavy v muzeich / galeriich",
