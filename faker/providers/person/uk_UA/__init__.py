...
class Provider(PersonProvider):
    ...
    first_names_male = (
        ...
        'Володимир', 'Вʼячеслав', 'Гаврило', 'Геннадій', 'Георгій', 'Герман ', 'Гордій', 'Григорій', 'Гліб', 'Данило',
        'Давид', 'Дан', 'Демид', 'Демʼян', 'Дмитро', 'Захар', 'Зиновій', 'Зорян', 'Іван', 'Ігнат', 'Ігор', 'Ілля',
        'Едуард', 'Євген', 'Єлисей', 'Єфрем', 'Йосип', 'Климент',
        'Костянтин', 'Левко', 'Лесь', 'Леон', 'Леонід', 'Леонтій', 'Леопольд', 'Лукʼян', 'Кирило', 'Макар', 'Максим',
    ...
    first_names_female = (
        ...
        'Ліза', 'Лілія', 'Людмила', 'Любов', 'Марія', 'Марина', 'Марта', 'Марʼяна', 'Маруся', 'Михайлина', 'Мілена',
    ...
    last_names = (
        ...
        # Б
        'Бабʼюк', 'Бабʼяк', 'Бабак', 'Бабариченко', 'Бабенко', 'Бабич', 'Бабиченко', 'Бабій', 'Бабійчук', 'Бабко',
        ...
        'Дейсун', 'Демʼяненко', 'Демʼянчук', 'Демʼянюк', 'Демиденко', 'Дергач', 'Деревʼянко',
        'Дерегус', 'Деркач', 'Деряжний', 'Джунь', 'Джус', 'Дробʼязко', 'Дробаха', 'Дрозд', 'Дрозденко',
        ...
        # П
        'Пʼятаченко', 'Павленко', 'Павлик', 'Павличенко', 'Палій', 'Панчук', 'Парасюк', 'Пелех', 'Перебийніс',
        ...
        # Х
        'Харченко', 'Хмара', 'Хоменко', 'Хомик', 'Хорішко', 'Христенко', 'Христич', 'Худобʼяк', 'Худяк',
        # Ц
