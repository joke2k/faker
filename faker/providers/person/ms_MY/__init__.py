...
class Provider(PersonProvider):
    """
    A Faker provider for generating fake Malaysian Name
    """
    ...
    nurName_tuple = ("", "", "", "", "Noor ", "Nor ", "Nur ", "Nur ", "Nur ", "Nurul ", "Nuur ")

    haji_tuple = ("", "", "", "", "Haji ", "Hj ")
    hajjah_tuple = ("", "", "", "", "Hajjah ", "Hjh ")
    titleMaleMalay_tuple = ("", "", "", "", "", "", "Syed ", "Wan ", "Nik ", "Che ")

    lastNameChinese_tuple = (
        "An",
        "Ang",
        "Au",
        "Au-Yong",
    ...
    firstNameFemaleChristian_tuple = (
        "Alice",
        "Alyssa",
        "Amber",
        "Amy",
    ...
    titleMale_tuple = ("En.", "Dr.", "Prof.", "Datuk", "Dato'", "Datuk Seri", "Dato' Sri", "Tan Sri", "Tun")
    ...
    def firstNameMaleMalay(self):
        return self.generator.random.choice(self.firstNameMaleMalay_tuple)

    def firstNameFemaleMalay(self):
        return self.generator.random.choice(self.firstNameFemaleMalay_tuple)

    def lastNameMalay(self):
        return self.generator.random.choice(self.lastNameMalay_tuple)

    def muhammadName(self):
        return self.generator.random.choice(self.muhammadName_tuple)

    def nurName(self):
        return self.generator.random.choice(self.nurName_tuple)

    def haji(self):
        return self.generator.random.choice(self.haji_tuple)

    def hajjah(self):
        return self.generator.random.choice(self.hajjah_tuple)

    def titleMaleMalay(self):
        return self.generator.random.choice(self.titleMaleMalay_tuple)

    def lastNameChinese(self):
        return self.generator.random.choice(self.lastNameChinese_tuple)

    def firstNameMaleChinese(self):
        return self.generator.random.choice(self.firstNameMaleChinese_tuple)

    def firstNameFemaleChinese(self):
        return self.generator.random.choice(self.firstNameFemaleChinese_tuple)

    def firstNameMaleChristian(self):
        return self.generator.random.choice(self.firstNameMaleChristian_tuple)

    def firstNameFemaleChristian(self):
        return self.generator.random.choice(self.firstNameFemaleChinese_tuple)

    def initialIndian(self):
        return self.generator.random.choice(self.initialIndian_tuple)

    def firstNameMaleIndian(self):
        return self.generator.random.choice(self.firstNameMaleIndian_tuple)

    def firstNameFemaleIndian(self):
        return self.generator.random.choice(self.firstNameFemaleIndian_tuple)

    def lastNameIndian(self):
        return self.generator.random.choice(self.lastNameIndian_tuple)
    ...
    def first_name(self, gender: Optional[SexLiteral] = None):
        formats = ""
    ...
    def name(self, gender: Optional[SexLiteral] = None):
        formats = ""
        if gender:
            if gender in ("F", "f"):
                formats = self.femaleNameFormats
            elif gender in ("M", "m"):
                formats = self.maleNameFormats
            else:
                raise ValueError("Gender must be one of F or M.")
        else:
            formats = self.random_element([self.femaleNameFormats, self.maleNameFormats])
