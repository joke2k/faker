...
class Provider(PersonProvider):
    ...
    first_names_male = (
        ...
        'Adelardo', 'Adolfito', 'Adolfo', 'Adrián', 'Adán', 'Agapito',
        'Agustín', 'Aitor', 'Albano', 'Albert', 'Alberto', 'Albino',
        'Alcides', 'Ale', 'Alejandro', 'Alejo', 'Alex', 'Alfonso',
        'Alfredo', 'Alonso', 'Alvaro', 'Amado', 'Amador', 'Amancio',
        'Amando', 'Amaro', 'Ambrosio', 'Amor', 'Américo', 'Amílcar',
        'Anacleto', 'Anastasio', 'Andrés', 'Andrés Felipe', 'Angelino',
        'Anselmo', 'Antonio', 'Aníbal', 'Apolinar', 'Ariel', 'Aristides',
        'Armando', 'Arsenio', 'Artemio', 'Arturo', 'Asdrubal', 'Atilio',
        'Augusto', 'Aureliano', 'Aurelio', 'Baldo', 'Baldomero',
        'Balduino', 'Baltasar', 'Bartolomé', 'Basilio', 'Baudelio',
        'Bautista', 'Benigno', 'Benito', 'Benjamín', 'Bernabé',
        'Bernardino', 'Bernardo', 'Berto', 'Blas', 'Bonifacio', 'Borja',
        'Bruno', 'Buenaventura', 'Calisto', 'Calixto', 'Camilo',
        'Cande', 'Candelario', 'Carlito', 'Carlitos', 'Carlos',
        'Carmelo', 'Casimiro', 'Cayetano', 'Cebrián', 'Cecilio',
        'Ceferino', 'Celestino', 'Celso', 'Cesar', 'Che', 'Chema',
        'Chucho', 'Chus', 'Chuy', 'Cipriano', 'Ciriaco', 'Cirino',
        'Ciro', 'Ciríaco', 'Claudio', 'Clemente', 'Cleto', 'Clímaco',
        'Conrado', 'Cornelio', 'Cosme', 'Cristian', 'Cristián',
        'Cristóbal', 'Cruz', 'Curro', 'Custodio', 'Cándido', 'César',
        'Damián', 'Dan', 'Dani', 'Daniel', 'Danilo', 'Darío', 'David',
        'Demetrio', 'Desi', 'Desiderio', 'Diego', 'Dimas', 'Dionisio',
        ...
        'Flavio', 'Florencio', 'Florentino', 'Fortunato', 'Fran',
        'Francisco', 'Francisco Javier', 'Francisco Jose', 'Fulgencio',
        'Félix', 'Gabino', 'Gabriel', 'Galo', 'Gaspar', 'Gastón',
        'Geraldo', 'Gerardo', 'Germán', 'Gervasio', 'Gerónimo', 'Gil',
        'Gilberto', 'Glauco', 'Godofredo', 'Gonzalo', 'Goyo', 'Graciano',
        'Gregorio', 'Guadalupe', 'Guillermo', 'Guiomar', 'Gustavo',
        'Haroldo', 'Hector', 'Heliodoro', 'Heraclio', 'Herberto',
        'Heriberto', 'Hermenegildo', 'Herminio', 'Hernando', 'Hernán',
        'Hilario', 'Hipólito', 'Horacio', 'Hugo', 'Humberto', 'Héctor',
        'Ibán', 'Ignacio', 'Iker', 'Ildefonso', 'Inocencio', 'Isaac',
        'Isaías', 'Isidoro', 'Isidro', 'Ismael', 'Ivan', 'Iván',
        'Jacinto', 'Jacobo', 'Jafet', 'Jaime', 'Javi', 'Javier', 'Jenaro',
        'Jeremías', 'Jerónimo', 'Jesús', 'Joan', 'Joaquin', 'Joaquín',
        'Joel', 'Jonatan', 'Jordi', 'Jordán', 'Jorge', 'Jose',
        'Jose Angel', 'Jose Antonio', 'Jose Carlos', 'Jose Francisco',
        'Jose Ignacio', 'Jose Luis', 'Jose Manuel', 'Jose Maria',
        'Jose Miguel', 'Jose Ramon', 'Josep', 'Josué', 'José',
        ...
        'Juan Luis', 'Juan Manuel', 'Juan Pablo', 'Juanito', 'Julian',
        'Julio', 'Julio César', 'Julián', 'Kike', 'Lalo', 'Leandro',
        'Leocadio', 'Leonardo', 'Leoncio', 'Leonel', 'Leopoldo', 'León',
        'Lino', 'Lisandro', 'Lope', 'Lorenzo', 'Loreto', 'Lucas',
        'Lucho', 'Luciano', 'Lucio', 'Luis', 'Luis Miguel',
        'Luis Ángel', 'Lupe', 'Luís', 'Lázaro', 'Macario', 'Manolo', 'Manu',
        'Manuel', 'Marc', 'Marcelino', 'Marcelo', 'Marcial', 'Marciano',
        ...
        'Miguel', 'Miguel Ángel', 'Miguelito', 'Modesto', 'Mohamed',
        'Moisés', 'Moreno', 'Máximo', 'Nacho', 'Nacio', 'Nando',
        'Narciso', 'Natalio', 'Natanael', 'Nazaret', 'Nazario',
        'Nicanor', 'Nico', 'Nicodemo', 'Nicolás', 'Nilo', 'Norberto',
        'Noé', 'Néstor', 'Octavio', 'Olegario', 'Omar', 'Onofre',
        'Osvaldo', 'Ovidio', 'Pablo', 'Paco', 'Pancho', 'Paquito',
        'Pascual', 'Pastor', 'Patricio', 'Paulino', 'Pedro', 'Pelayo',
        'Pepe', 'Pepito', 'Plinio', 'Plácido', 'Poncio', 'Porfirio',
        'Primitivo', 'Prudencio', 'Pánfilo', 'Pío', 'Quique', 'Quirino',
        'Rafa', 'Rafael', 'Raimundo', 'Ramiro', 'Ramon', 'Ramón',
        'Raul', 'Raúl', 'Reinaldo', 'Remigio', 'Renato', 'René',
        'Reyes', 'Reynaldo', 'Ricardo', 'Rico', 'Roberto', 'Rodolfito',
        'Rodolfo', 'Rodrigo', 'Rogelio', 'Rolando', 'Roldán', 'Román',
        'Roque', 'Rosario', 'Rosendo', 'Ruben', 'Rubén', 'Rufino',
        'Ruperto', 'Ruy', 'Régulo', 'Rómulo', 'Sabas', 'Salomón',
        'Salvador', 'Samu', 'Samuel', 'Sancho', 'Sandalio', 'Santiago',
        'Santos', 'Saturnino', 'Sebastian', 'Sebastián', 'Segismundo',
        'Sergio', 'Seve', 'Severiano', 'Severino', 'Severo', 'Sigfrido',
        'Silvestre', 'Silvio', 'Simón', 'Sosimo', 'Tadeo', 'Telmo', 'Teo',
        'Teobaldo', 'Teodoro', 'Teodosio', 'Teófilo', 'Tiburcio',
        'Timoteo', 'Tito', 'Tomás', 'Toni', 'Toribio', 'Toño', 'Trinidad',
        'Tristán', 'Ulises', 'Urbano', 'Valentín', 'Valerio', 'Valero',
        'Vasco', 'Venceslás', 'Vicente', 'Victor', 'Victor Manuel',
        'Victoriano', 'Victorino', 'Vidal', 'Vinicio', 'Virgilio', 'Vito',
        'Víctor', 'Wilfredo', 'Wálter', 'Xavier', 'Yago', 'Zacarías',
        'Álvaro', 'Ángel', 'Édgar', 'Íñigo', 'Óscar',
    )

    first_names_female = (
        'Abigaíl', 'Abril', 'Adela', 'Adelaida', 'Adelia',
        'Adelina', 'Adora', 'Adoración', 'Adriana', 'Agata', 'Agustina',
        'Ainara', 'Ainoa', 'Aitana', 'Alba', 'Albina', 'Ale',
        'Alejandra', 'Alexandra', 'Alicia', 'Alma', 'Almudena', 'Alondra',
        'Amada', 'Amalia', 'Amanda', 'Amarilis', 'Amaya', 'Amelia',
        'Amor', 'Amparo', 'América', 'Ana', 'Ana Belen', 'Ana Sofía',
        'Anabel', 'Anastasia', 'Andrea', 'Angela', 'Angelina',
        'Angelita', 'Angélica', 'Ani', 'Anita', 'Anna', 'Anselma',
        'Antonia', 'Anunciación', 'Apolonia', 'Araceli', 'Aracelis',
        'Aracely', 'Arcelia', 'Ariadna', 'Ariel', 'Armida', 'Aroa',
        'Aránzazu', 'Ascensión', 'Asun', 'Asunción', 'Aura', 'Aurelia',
        'Aurora', 'Azahar', 'Azahara', 'Azeneth', 'Azucena', 'Beatriz',
        'Begoña', 'Belen', 'Belén', 'Benigna', 'Benita', 'Bernarda',
        'Bernardita', 'Berta', 'Bibiana', 'Bienvenida', 'Blanca',
        'Brunilda', 'Brígida', 'Bárbara', 'Calista', 'Calixta', 'Camila',
        'Cande', 'Candela', 'Candelaria', 'Candelas', 'Caridad',
        'Carina', 'Carla', 'Carlota', 'Carmela', 'Carmelita', 'Carmen',
        'Carmina', 'Carolina', 'Casandra', 'Catalina', 'Cayetana',
        'Cecilia', 'Celestina', 'Celia', 'Charo', 'Chelo', 'Chita',
        'Chus', 'Cintia', 'Clara', 'Clarisa', 'Claudia', 'Clementina',
        'Cloe', 'Clotilde', 'Concepción', 'Concha', 'Conchita',
        'Constanza', 'Consuela', 'Consuelo', 'Coral', 'Corona',
        'Crescencia', 'Cristina', 'Cruz', 'Cruzita', 'Custodia', 'Cándida',
        'Dafne', 'Dalila', 'Daniela', 'Delfina', 'Delia', 'Diana',
        'Dionisia', 'Dolores', 'Dominga', 'Domitila', 'Dora', 'Dorita',
        'Dorotea', 'Dulce', 'Débora', 'Edelmira', 'Elba', 'Elena', 'Eli',
        'Eliana', 'Eligia', 'Elisa', 'Elisabet', 'Elodia', 'Eloísa',
        'Elvira', 'Ema', 'Emelina', 'Emilia', 'Emiliana', 'Emma',
        'Emperatriz', 'Encarna', 'Encarnacion', 'Encarnación', 'Encarnita',
        ...
        'Florinda', 'Fortunata', 'Fran', 'Francisca', 'Fátima',
        'Gabriela', 'Gala', 'Gema', 'Genoveva', 'Georgina', 'Gertrudis',
        'Gisela', 'Gloria', 'Gracia', 'Graciana', 'Graciela',
        'Griselda', 'Guadalupe', 'Guiomar', 'Haydée', 'Herminia', 'Hilda',
        'Hortensia', 'Ignacia', 'Ileana', 'Imelda', 'Ines', 'Inma',
        'Inmaculada', 'Inés', 'Irene', 'Iris', 'Irma', 'Isa', 'Isabel',
        'Isabela', 'Isaura', 'Isidora', 'Itziar', 'Jacinta', 'Javiera',
        'Jenifer', 'Jennifer', 'Jenny', 'Jessica', 'Jesusa', 'Jimena',
        'Joaquina', 'Jordana', 'Josefa', 'Josefina', 'José', 'Jovita',
        'Juana', 'Juanita', 'Judit', 'Judith', 'Julia', 'Juliana',
        'Julie', 'Julieta', 'Lara', 'Laura', 'Laurita', 'Leandra',
        'Leire', 'Leocadia', 'Leonor', 'Leticia', 'Leyre', 'Lidia',
        'Ligia', 'Lilia', 'Liliana', 'Lina', 'Loida', 'Lola', 'Lolita',
        'Lorena', 'Lorenza', 'Loreto', 'Lourdes', 'Luciana', 'Lucila',
        'Lucía', 'Luisa', 'Luisina', 'Luisita', 'Luna', 'Lupe',
        'Lupita', 'Luz', 'Macarena', 'Macaria', 'Magdalena', 'Maite',
        'Malena', 'Mamen', 'Manola', 'Manu', 'Manuela', 'Manuelita',
        'Mar', 'Marcela', 'Marcia', 'Margarita', 'Mariana',
        'Marianela', 'Marianita', 'Maribel', 'Maricela', 'Maricruz',
        'Marina', 'Marisa', 'Marisela', 'Marisol', 'Maristela',
        'Marita', 'Marta', 'Martina', 'Martirio', 'Martita', 'María',
        ...
        'Milagros', 'Mireia', 'Mireya', 'Miriam', 'Mirta', 'Modesta',
        'Montserrat', 'Morena', 'Máxima', 'Mónica', 'Nadia', 'Narcisa',
        'Natalia', 'Natividad', 'Nayara', 'Nazaret', 'Nerea', 'Nereida',
        'Nicolasa', 'Nidia', 'Nieves', 'Nilda', 'Noa', 'Noelia', 'Noemí',
        'Nohemi', 'Nuria', 'Nydia', 'Nélida', 'Obdulia', 'Octavia',
        'Odalis', 'Odalys', 'Ofelia', 'Olalla', 'Olga', 'Olimpia',
        'Olivia', 'Oriana', 'Otilia', 'Paca', 'Pacífica', 'Palmira',
        'Paloma', 'Paola', 'Paquita', 'Pascuala', 'Pastora', 'Patricia',
        'Paula', 'Paulina', 'Paz', 'Pepita', 'Perla', 'Perlita',
        'Petrona', 'Piedad', 'Pilar', 'Pili', 'Primitiva', 'Priscila',
        'Prudencia', 'Purificación', 'Pía', 'Rafaela', 'Ramona', 'Raquel',
        'Rebeca', 'Regina', 'Reina', 'Remedios', 'Renata', 'Reyes',
        'Reyna', 'Ricarda', 'Rita', 'Roberta', 'Robertina', 'Rocio',
        'Rocío', 'Rosa', 'Rosa María', 'Rosalina', 'Rosalinda',
        'Rosalva', 'Rosalía', 'Rosario', 'Rosaura', 'Rosenda', 'Rosita',
        'Roxana', 'Rufina', 'Ruperta', 'Rut', 'Ruth', 'Sabina', 'Salomé',
        'Salud', 'Samanta', 'Sandra', 'Sara', 'Sarita', 'Saturnina',
        'Selena', 'Serafina', 'Silvia', 'Socorro', 'Sofia', 'Sofía',
        'Sol', 'Soledad', 'Sonia', 'Soraya', 'Susana', 'Susanita',
        'Tamara', 'Tania', 'Tatiana', 'Tecla', 'Teodora', 'Tere',
        'Teresa', 'Teresita', 'Teófila', 'Tomasa', 'Trini', 'Trinidad',
        'Valentina', 'Valeria', 'Vanesa', 'Vera', 'Verónica', 'Vicenta',
        'Victoria', 'Vilma', 'Violeta', 'Virginia', 'Visitación',
        'Viviana', 'Ximena', 'Xiomara', 'Yaiza', 'Yolanda', 'Yésica',
        'Yéssica', 'Zaira', 'Zoraida', 'África', 'Águeda', 'Ámbar',
        'Ángela', 'Ángeles', 'Áurea', 'Íngrid', 'Úrsula',
    )
