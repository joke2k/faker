...
class Provider(PersonProvider):
    ...
    first_names_male = (
        ...
        'Alfredo', 'Alfonso', 'Amadeo', 'Amedeo', 'Amico', 'Amleto', 'Angelo', 'Annibale',
        'Ansaldo', 'Antonello', 'Antonino', 'Antonio', 'Armando', 'Arnaldo', 'Arnulfo',
        'Arsenio', 'Arturo', 'Atenolfo', 'Augusto', 'Azeglio', 'Baccio', 'Baldassare',
        ...
        'Guido', 'Gustavo', 'Ignazio', 'Ippazio', 'Ivan', 'Ivo', 'Jacopo',
    ...
    first_names_female = (
        ...
        'Serafina', 'Serena', 'Silvia', 'Simonetta', 'Sole', 'Sonia', 'Sofia', 'Stefani',
