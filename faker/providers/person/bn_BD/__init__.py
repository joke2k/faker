...
class Provider(PersonProvider):
    ...
    first_names_male_common = (
        "অর্ক", "আকাশ", "আরিয়ান", "আদি", "অভিষেক", "অভি", "আনন্দ", "আবির",
        "ইমন",
        "চয়ন", "চঞ্চল",
        "তন্ময়", "তনয়", "তুষার",
        "নয়ন",
        "প্রান্ত", "প্রিতম", "প্রিয়ম", "প্রিয়", "প্রত্যয়",
        "বাদল",
        "মিলন",
        "রাহুল", "রোহিত",
        "লিটন",
    ...
    first_names_male_hinduism = (
        "অর্ঘ্য", "অশোক", "অজিত", "অর্ণব", "অক্ষয়", "অমল", "অজয়",
        "আশীষ", "আশুতোষ", "আয়ুষ",
        "কুনাল",
        "জয়ন্ত", "জয়দীপ", "জগদীশ",
        "প্রদ্যুম্ন", "প্রদীপ", "প্রশান্ত",
        "বিনয়", "বিরাট",
        "মৃনাল", "মৃত্যুঞ্জয়", "মনোজ",
        "শেখর",
        "সুশান্ত", "সৌমিক", "সৌম্য",
    )

    first_names_male_islamic = (
        "আবু", "আতাহার", "আজাদ", "আসাদ", "আনিস", "আজম", "আব্বাস",
        "ইকবাল", "ইউসুফ", "ইশতিয়াক", "ইমতিয়াজ", "ইজাজ",
        "এনামুল", "একরামুল",
        "কাফি", "করিম",
        "তামিম",
        "নাদিম", "নাইম",
        "বাকের", "বাসির",
        "মুনতাসির", "মুনতাকিম", "মোস্তাফিজ", "মুশফিক",
        "রায়হান", "রহিম", "রাশেদ", "রাসেল", "রাশেদুল",
        "শাহাবাজ", "শাহজাহান", "শহিদুল",
        "সাবের", "সাব্বির",
    )

    first_names_female_common = (
        "অর্পিতা", "অঞ্জনা", "অহনা", "অন্তরা", "অর্না", "অনন্যা",
        "আরিয়া", "আশা", "আলিয়া",
        "ইশিতা",
        "কেয়া", "কবিতা", "কাজল",
        "খুশি",
        ...
        "জনা",
        "নন্দিতা", "নিশিতা",
        "প্রীতি", "প্রিয়তি", "প্রিয়াঙ্কা", "প্রিয়া",
        "বাঁধন", "বৃষ্টি", "বিনা", "বিপাশা",
        "মিথিলা", "মিষ্টি", "মিলা", "মিনা", "মিম",
        "রিনা",
        "লতা",
        "শ্রাবনী", "শ্রাবন্তী",
        "সুরভি",
    ...
    first_names_female_hinduism = (
        "অদৃতা", "অনিন্দিতা", "অলোকা", "অদিতি",
        "আমায়া", "আরাধ্যা", "আরুণি", "আশালতা", "আশ্বিনী", "আয়ুশি",
        "ঋষিতা",
        "ঈশানি",
        "কাবেরি",
        "দূর্গা",
    ...
    first_names_female_islamic = (
        "আক্তারা", "আফিয়া", "আসিফা", "আফিফা", "আফসানা", "আয়েশা",
        "জোবায়দা",
        "তাসফিয়া", "তাসনিম", "তামান্না",
        "নুসরাত",
        "ফৌজিয়া", "ফারিহা",
        "মেহজাবিন", "মোনালিসা", "মালিহা",
        "রাজিয়া", "রোজিনা",
        "শারমিন",
        "সানজিদা", "সুমাইয়া",
    )
    ...
    last_names_hinduism = (
        "আচার্য্য",
        "কুমার", "কান্ত",
        "গাঙ্গুলি", "গঙ্গোপাধ্যায়",
        "ঘোষ",
        "চ্যাটার্জি", "চট্টোপাধ্যায়", "চন্দ্র",
        "ঠাকুর",
        "দত্ত", "দাস", "দেব", "দে", "দাশগুপ্তা",
        "পাল", "পোদ্দার", "পাণ্ডে", "প্রধান",
        "ব্যানার্জি", "বন্দোপাধ্যায়", "বোস", "বসু", "বর্মন", "বাগচী",
        "মুখার্জি", "মিশ্র", "মিত্র",
        "যাদব",
        "শুক্লা",
        "সাহা", "সিং", "সেন",
        "রায়", "রাও",
    ...
    last_names_islamic = (
        "আলি", "আক্তার", "আওয়াল", "আলম", "আবদুল্লাহ",
        "ইসলাম",
        "উদ্দিন",
        "কাদের",
        "খান",
