...
from faker.exceptions import LocaleSpecificWarning
...
class Provider(BankProvider):
    ...
    def bban(self):
        ...
        .. warning::
           ...
           this method will also raise a ``LocaleSpecificWarning`` regarding the hypotheticality
           of the result.

        :sample:
        """
        warnings.warn("Numbers generated by this method are purely hypothetical.", LocaleSpecificWarning)
        return super().bban()
    ...
    def iban(self):
        ...
        .. warning::
           ...
           raise a ``LocaleSpecificWarning`` regarding the hypotheticality of the result.
