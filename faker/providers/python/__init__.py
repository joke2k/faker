...
class Provider(BaseProvider):
    ...
    def pyint(self, min_value: int = 0, max_value: int = 9999, step: int = 1, avoid_value: int = None) -> int:
        return self.generator.random_int(min_value, max_value, step=step, avoid_value=avoid_value)
