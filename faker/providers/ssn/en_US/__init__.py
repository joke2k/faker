...
class Provider(BaseProvider):
    ...
    def ssn(self, taxpayer_identification_number='ssn'):
        ...
        if taxpayer_identification_number.lower() == 'ssn':
        ...
        elif taxpayer_identification_number.lower() == 'itin':
        ...
        # https://www.irs.gov/businesses/small-businesses-self-employed/employer-id-numbers
        ...
        elif taxpayer_identification_number.lower() == 'ein':
            ...
            ssn = ssn = "{0:s}-{1:07d}".format(ein_prefix, sequence)
