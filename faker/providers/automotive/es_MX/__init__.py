...
class Provider(AutomotiveProvider):
    ...
    license_plate_state_abbr = tuple(license_plate_states.keys())
    ...
    def state_abbr(self) -> str:
        ...
        return self.random_element(self.license_plate_state_abbr)

    def state(self) -> str:
        """Return the official name of a random federal entity."""
        return self.license_plate_states[self.state_abbr()]
    ...
    def license_plate_by_state(self, state_abbr: Optional[str] = None) -> str:
        ...
        """
        state_abbr = state_abbr if state_abbr is not None else self.state_abbr()
