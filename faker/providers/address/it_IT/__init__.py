...
class Provider(AddressProvider):
    ...
    admin2_in_admin1 = {
        ...
        "Regione Basilicata": ["Provincia di Matera", "Provincia di Potenza"],
        "Regione Calabria": [
        ...
        "Regione Trentino-Alto Adige, Trentino-Südtirol (de)": [
            "Provincia autonoma di Bolzano",
            "Provincia autonoma di Trento",
        ],
        "Regione Umbria": ["Provincia di Perugia", "Provincia di Terni"],
        "Regione Valle d'Aosta, Vallée d'Aoste (fr)": [],
        "Regione Veneto": [
    ...
    admin2 = administrative_unit

    def admin1(self) -> str:
        return self.random_element(tuple(self.admin2_in_admin1.keys()))
