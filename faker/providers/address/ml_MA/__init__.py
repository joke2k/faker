...
class Provider(AddressProvider):
    ...
    street_suffixes = [
        ...
        'D. S. Ramanathan', 'Damansara', 'Dang Wangi', 'Davis', 'Dewan Bahasa', 'Dato Abdul Rahman', 'Dato\'Keramat',
        'Dato\' Maharaja Lela', 'Doraisamy',
        'Eaton',
        'Faraday',
        ...
        'P. Ramlee', 'Padang Kota Lama', 'Pahang', 'Pantai Baharu', 'Parlimen', 'Pasar', 'Pasar Besar', 'Perak',
        'Perdana', 'Petaling', 'Prangin', 'Pudu', 'Pudu Lama',
        'Raja', 'Raja Abdullah', 'Raja Chulan', 'Raja Laut', 'Rakyat', 'Residensi', 'Robson',
        'S.P. Seenivasagam', 'Samarahan 1', 'Selamat', 'Sempadan', 'Sentul', 'Serian 1', 'Sasaran', 'Sin Chee',
        'Sultan Abdul Samad', 'Sultan Azlan Shah', 'Sultan Iskandar', 'Sultan Ismail', 'Sultan Sulaiman', 'Sungai Besi',
        'Syed Putra',
        'Tan Cheng Lock', 'Thambipillay', 'Tugu', 'Tuanku Abdul Halim', 'Tuanku Abdul Rahman', 'Tun Abdul Razak',
        'Tun Dr Ismail', 'Tun H S Lee', 'Tun Ismail', 'Tun Perak', 'Tun Razak', 'Tun Sambanthan',
        'U-Thant', 'Utama',
        'Vermont', 'Vivekananda',
    ...
    town_suffixes = [
        ...
        'Saujana', 'Segambut', 'Selamat', 'Selatan', 'Semarak', 'Sentosa', 'Seputeh', 'Setapak', 'Setia Jaya', 'Sinar',
        'Sungai Besi', 'Sungai Buaya', 'Sungai Long', 'Suria',
    ...
    country = [
        ...
        'Bolivia', 'Bonaire', 'Bosnia dan Herzegovina', 'Botswana', 'Brazil', 'Brunei Darussalam', 'Bulgaria',
        ...
        'Kanada', 'Kazakhstan', 'Kemboja', 'Kenya', 'Kiribati', 'Korea Selatan', 'Korea Utara', 'Kosovo', 'Kuwait',
        'Kyrgyzstan',
    ...
    def postcode(self):
        format = {
            'perlis' : [
                self.random.randint(1000, 2800)
            ],
            'kedah' : [
                self.random.randint(5000, 9810)
            ],
            'penang' : [
                self.random.randint(10000, 14400)
            ],
            'kelantan' : [
                self.random.randint(15000, 18500)
            ],
            'terengganu' : [
                self.random.randint(20000, 24300)
            ],
            'pahang' : [
                self.random.randint(25000, 28800),
                self.random.randint(39000, 39200),
                self.random.randint(49000, 69000)
            ],
            'perak' : [
                self.random.randint(30000, 36810)
            ],
            'selangor' : [
                self.random.randint(40000, 48300),
                self.random.randint(63000, 68100)
            ],
            'kl' : [
                self.random.randint(50000, 60000)
            ],
            'putrajaya': [
                self.random.randint(62000, 62988)
            ],
            'nsembilan' : [
                self.random.randint(70000, 73509)
            ],
            'melaka' : [
                self.random.randint(75000, 78309)
            ],
            'johor' : [
                self.random.randint(79000, 86900)
            ],
            'labuan' : [
                self.random.randint(87000, 87033)
            ],
            'sabah' : [
                self.random.randint(88000, 91309)
            ],
            'sarawak' : [
                self.random.randint(93000, 98859)
            ]
        }
        if var == None:
            postcode = self.random_element(self.format(self.state))
            return self.random_element(self.postcode)

    def town_state(self):
        state = self.random_element(self.key(self.town) for key, value in self.town.items())
