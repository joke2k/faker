...
class Provider(BaseProvider):
    ...
    mobile_number_formats: Tuple[str, ...] = globe_mobile_number_formats + smart_mobile_number_formats + \
        sun_mobile_number_formats

    bayantel_landline_identifiers: Tuple[str, ...] = tuple(str(x) for x in range(3000, 3500))
    misc_landline_identifiers: Tuple[str, ...] = tuple(str(x) for x in range(5300, 5800)) + \
