...
class Provider(AddressProvider):
    ...
    cities = (
        "Ajdovščina", "Bled", "Bovec", "Brežice",
        "Celje", "Cerknica", "Črnomelj", "Domžale",
        ...
        "Lenart v Slovenskih goricah", "Lendava",
        "Litija", "Ljubljana", "Ljutomer",
        "Logatec", "Maribor", "Medvode", "Mengeš",
        "Metlika", "Mežica", "Murska Sobota",
        "Nova Gorica", "Novo mesto", "Ormož", "Piran",
        "Postojna", "Prevalje", "Ptuj",
        "Radeče", "Radovljica", "Ravne na Koroškem",
        ...
        "Šoštanj", "Tolmin", "Trbovlje", "Trebnje",
    ...
    countries = (
        ...
        "Gruzija", "Gvajana", "Republika Gvajana", "Gvatemala",
        "Republika Gvatemala",
        "Gvineja", "Republika Gvineja", "Gvineja Bissau",
        ...
        "Mikronezija", "Združene države Mikronezije",
        "Mjanmar", "Zveza Mjanmar", "Moldavija",
        "Moldavija, Republika",
        "Monako", "Kneževina Monako", "Mongolija",
        "Mozambik", "Republika Mozambik",
        "Namibija", "Republika Namibija", "Nauru",
        "Republika Nauru", "Nemčija",
        "Zvezna republika Nemčija", "Nepal", "Kraljevina Nepal",
        "Niger", "Republika Niger",
        "Nigerija", "Zvezna republika Nigerija", "Nikaragva",
        "Republika Nikaragva",
        "Nizozemska", "Kraljevina Nizozemska", "Norveška",
        "Kraljevina Norveška",
        ...
        "Portugalska",
        "Portugalska republika", "Romunija", "Ruanda",
        "Republika Ruanda", "Rusija",
        "Ruska federacija", "Saint Kitts in Nevis", "Saint Lucia",
        "Saint Vincent in Grenadine", "Salomonovi otoki", "Salvador",
        "Republika Salvador", "San Marino",
        "Republika San Marino", "Sao Tome in Principe",
        "Demokratična republika Sao Tome in Principe", "Saudova Arabija",
        "Kraljevina Saudova Arabija", "Sejšeli",
        "Republika Sejšeli", "Senegal",
        "Republika Senegal", "Severna Koreja",
        "Demokratična ljudska republika Koreja",
        "Sierra Leone", "Republika Sierra Leone", "Singapur",
        "Republika Singapur", "Sirija",
        "Sirska arabska republika", "Slonokoščena obala",
        "Republika Slonokoščena obala",
        "Slovaška", "Slovaška republika", "Slovenija",
        "Republika Slovenija", "Somalija",
        "Somalska demokratična republika", "Srbija",
        "Republika Srbija", "Srednjeafriška republika",
        "Sudan", "Republika Sudan", "Surinam",
        "Republika Surinam", "Svazi", "Kraljevina Svazi",
        "Španija", "Kraljevina Španija", "Šrilanka",
        "Demokratična socialistična republika Šrilanka",
        "Švedska", "Kraljevina Švedska", "Švica",
        "Švicarska konfederacija", "Tadžikistan",
        "Republika Tadžikistan", "Tajska", "Kraljevina Tajska",
        "Tajvan", "Tajvan, Provinca Kitajske",
        "Tanzanija", "Združena republika Tanzanija",
        "Togo", "Togoška republika", "Tonga",
        "Kraljevina Tonga", "Trinidad in Tobago",
        "Republika Trinidad in Tobago", "Tunizija",
        "Republika Tunizija", "Turčija", "Republika Turčija",
        "Turkmenistan", "Tuvalu",
        "Uganda", "Republika Uganda", "Ukrajina",
