...
class Provider(PersonProvider):
    ...
    first_names_male = [
        ...
        "Daniel", "Dominik", "Miloš", "Stojan", "Tomislav",
        "Franjo", "Valentin",
        "Davorin", "Maks", "Timotej", "Ladislav", "Niko",
        "Mario", "Mark", "Nikola",
        "Bogomir", "Saša", "Vlado", "Karl", "Zdenko", "Mladen",
        "Grega", "Stjepan",
        "Davor", "Kristijan", "Ernest", "Maksimiljan", "Patrik",
        "Avgust", "Sebastijan",
