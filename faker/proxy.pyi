...
class Faker:
    ...
    def random_number(self, digits: Optional[int] = ..., fix_len: bool = ...) -> int:
        ...
        """
        ...
    def random_sample(self, elements: Union[Collection[str], Collection[T], collections.OrderedDict[T, float]] = ..., length: Optional[int] = ...) -> Sequence[T]:
        """
    ...
    def json(self, data_columns: Optional[List] = ..., num_rows: int = ..., indent: Optional[int] = ..., cls: Optional[Type[json.encoder.JSONEncoder]] = ...) -> str:
        ...
        """
        ...
    def json_bytes(self, data_columns: Optional[List] = ..., num_rows: int = ..., indent: Optional[int] = ..., cls: Optional[Type[json.encoder.JSONEncoder]] = ...) -> bytes:
        """
