...
from typing import Literal, Callable, Iterator, Dict, Type, Set, Any, Optional, Sequence, Collection, Union, List, Iterable, Tuple, TypeVar
...
from types import faker.generator.Generator | None, list[str] | None
